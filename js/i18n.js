...
const TRANSLATIONS = {
  en: {
    ...
    'upload.startHint':  'XLSX or CSV export — beginning of KvK',
    'upload.endLabel':   'KvK End',
    'upload.endHint':    'XLSX or CSV export — end of KvK',
  ...
  ja: {
    ...
    'upload.startHint':  'XLSXまたはCSV — KvK開始時',
    'upload.endLabel':   'KvK 終了',
    'upload.endHint':    'XLSXまたはCSV — KvK終了時',
